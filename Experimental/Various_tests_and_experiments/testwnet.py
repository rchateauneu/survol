		...
		while 1:
			...
			for item in items:
				try:
					...
					# Couldn't enumerate this resource: The network path was not found.
					# Couldn't enumerate this resource: Access is denied.
...
#D:\Projects\Divers\Reverse\PythonStyle\htbin\tests_oldies>python testwnet.py
#Current global user is 'UK936025'
#Enumerating all resources on the network - this may take some time...
#Enumerating Microsoft Terminal Services
#Enumerating Microsoft Windows Network
# Enumerating EURO
#  Enumerating \\LONM00050578
#  Couldn't enumerate this resource: The network path was not found.
#  Enumerating \\LONW000063245
#  Enumerating \\LONW00050624
#  Enumerating \\LONW00050914
