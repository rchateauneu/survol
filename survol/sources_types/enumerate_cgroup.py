...
def Main():
    ...
    prop_cgroup = lib_util.MakeProp("cgroup")
    ...
    for lin_cg in fil_cg.readlines():
        ...
        grph.add((cgroup_node, lib_util.MakeProp("Hierarchy"), lib_util.NodeLiteral(split_cg[1])))
        grph.add((cgroup_node, lib_util.MakeProp("Num cgroups"), lib_util.NodeLiteral(split_cg[2])))
        grph.add((cgroup_node, lib_util.MakeProp("Enabled"), lib_util.NodeLiteral(split_cg[3])))
