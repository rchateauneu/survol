...
def Main():
	...
	if iijList:
		...
		for iijOne in iijList:
			...
			grph.add( ( symNod, lib_util.MakeProp("plt"), lib_util.NodeLiteral(ii_plt) ) )
			grph.add( ( symNod, lib_util.MakeProp("type"), lib_util.NodeLiteral(ii_type) ) )
			grph.add( ( symNod, lib_util.MakeProp("bind"), lib_util.NodeLiteral(ii_bind) ) )
