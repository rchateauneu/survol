...
def Main():
    ...
    for row in result:
        ...
        grph.add((node_session, lib_util.MakeProp("Oracle user"), lib_util.NodeLiteral(ora_username)))
        grph.add((node_session, lib_util.MakeProp("Schema"), lib_util.NodeLiteral(schema_name)))
        grph.add((node_session, lib_util.MakeProp("Program"), lib_util.NodeLiteral(sess_program)))
        ...
        grph.add((node_process, lib_util.MakeProp("SystemPid"), lib_util.NodeLiteral(user_proc_id)))
        grph.add((node_process, lib_util.MakeProp("OraclePid"), lib_util.NodeLiteral(process_pid)))
        grph.add((node_process, lib_util.MakeProp("Terminal"), lib_util.NodeLiteral(proc_terminal)))
        ...
        if sess_osuser != None:
            ...
            grph.add((node_os_user, lib_util.MakeProp("OsUser"), lib_util.NodeLiteral(sess_osuser)))
