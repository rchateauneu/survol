...
def DispApp(grph,configNode,configName):
	...
	for elt_app in dom.getElementsByTagName('app'):
		...
		grph.add( ( nodeApp, lib_common.MakeProp("version"), lib_util.NodeLiteral( attr_version ) ) )
		grph.add( ( nodeApp, lib_common.MakeProp("notifref"), lib_util.NodeLiteral( attr_notifref ) ) )
		grph.add( ( nodeApp, lib_common.MakeProp("cronref"), lib_util.NodeLiteral( attr_cronref ) ) )
