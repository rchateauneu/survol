...
def Main():
	...
	sql_query = "SELECT OBJECT_NAME,STATUS,CREATED FROM DBA_OBJECTS WHERE OBJECT_TYPE = 'PACKAGE' AND OWNER = '" + oraSchema + "'"
	...
	sys.stderr.write("num_packages=%d\n" % num_packages )
	...
	cgiEnv.OutCgiRdf(grph,"LAYOUT_RECT", [pc.property_oracle_package])
